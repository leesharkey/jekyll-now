...
All this said, it is only the systems neuroscience-centred agenda that provides us with a rational, unified framework that accommodates the many functions we have highlighted in this guide like imagination-based planning, hierarchical planning, language grounding, abstract concepts, intuitive physics, intuitive psychology, causal reasoning, continual learning, predictive world models, one-shot learning, all at the same time. In other words: it is at present the only agenda that can provide a rational, complete framework for our thinking about general intelligence.
