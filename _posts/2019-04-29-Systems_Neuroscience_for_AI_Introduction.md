...
<p markdown='1' style="text-align:right">Next post: [Motivation - Why should we pay attention to the brain for AI?]({{ site.baseurl }}/Systems_Neuroscience_for_AI_Motivation/)
